                            ...
                            <Card className="mt-2">
                                ...
                                <Card.Body style={{height: "300px"}}>
                                    ...
                                    <Table table hover size="sm">
                                        <thead>
                                        <tr>
                                            <th scope="col" style={{verticalAlign: "middle", textAlign: "center"}} className="col-2"> Mã vật tư </th>
                                            <th scope="col" style={{verticalAlign: "middle", textAlign: "center"}} className="col-3"> Tên vật tư </th>
                                            <th scope="col" style={{verticalAlign: "middle", textAlign: "center"}} className="col-1"> Số lượng</th>
                                            <th scope="col" style={{verticalAlign: "middle", textAlign: "center"}} className="col-2"> Ngày nhập kho </th>
                                            <th scope="col" style={{verticalAlign: "middle", textAlign: "center"}} className="col-2"> Hạn sử dụng </th>
                                            <th> </th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        {oldItems.map((oldItem) => {
                                            return (
                                                <tr key={oldItem.id}>
                                                    ...
                                                    <td style={{verticalAlign: "middle", textAlign: "center"}}>{oldItem.quantity}</td>
                                        ...
                                        {newItems.map((newItem) => {
                                            return (
                                                <tr key={newItem.id}>
                                                    ...
                                                    <td style={{verticalAlign: "middle", textAlign: "center"}}>{newItem.quantity}</td>
